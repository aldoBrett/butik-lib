CREATE TABLE
  IF NOT EXISTS butiks_engine.inventories (
    ...
    -- Ensures a lot referenced here belongs to the same product variant as this row.
    FOREIGN KEY (product_lot_id, product_variant_id) REFERENCES butiks_engine.product_lots (id, product_variant_id) ON DELETE CASCADE
  );
